...
public class shoes extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        // Set up FirebaseRecyclerOptions to query for products in the "shoes" category
        options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(ProductRef.orderByChild("category").equalTo("Shoes"), Products.class)
                .build();
        ...
        adapter = new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(v -> {
                    Intent intent = new Intent(shoes.this, ProductDetailsActivity.class);
            ...
            public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(shoes.this).inflate(R.layout.product_items_layout, parent, false);
