...
public class man_clothes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_clothes);
    ...
    protected void onStart() {
        ...
        // Set up FirebaseRecyclerOptions to query for products in the "man_clothes" category
        options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(ProductRef.orderByChild("category").equalTo("man_clothes"), Products.class)
                .build();
        ...
        adapter = new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(v -> {
                    Intent intent = new Intent(man_clothes.this, ProductDetailsActivity.class);
            ...
            public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(man_clothes.this).inflate(R.layout.product_items_layout, parent, false);
