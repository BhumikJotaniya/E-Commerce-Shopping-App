...
public class laptop extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        // Set up FirebaseRecyclerOptions to query for products in the "laptop" category
        ...
        adapter = new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(v -> {
                    Intent intent = new Intent(laptop.this, ProductDetailsActivity.class);
            ...
            public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(laptop.this).inflate(R.layout.product_items_layout, parent, false);
