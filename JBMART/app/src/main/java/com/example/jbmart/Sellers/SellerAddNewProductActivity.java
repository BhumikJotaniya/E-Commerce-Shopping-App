...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    private String CategoryName, ProductName, ProductDescription, ProductPrice, saveCurrentDate, saveCurrentTime, sellerphone;
    private ImageView InputProductImage;
    private Button AddNewProductButton;
    private EditText InputProductName, InputProductDescription, InputProductPrice, InputSellerPhone;
    ...
    private String sName, sPhone, sEmail, sAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputSellerPhone = findViewById(R.id.sellerphone);
    ...
    private void validateProductData() {
        ...
        sellerphone = InputSellerPhone.getText().toString();
        ...
        if (ImageUri == null) {
            ...
            Toast.makeText(this, "Please enter seller phone.", Toast.LENGTH_SHORT).show();
        } else {
