...
public class electronics extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        // Set up FirebaseRecyclerOptions to query for products in the "electronics" category
        options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(ProductRef.orderByChild("category").equalTo("electronics"), Products.class)
                .build();
        ...
        adapter = new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
            ...
            public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(electronics.this).inflate(R.layout.product_items_layout, parent, false);
