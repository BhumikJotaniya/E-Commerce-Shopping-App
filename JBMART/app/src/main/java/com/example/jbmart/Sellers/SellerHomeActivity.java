...
import com.example.jbmart.ViewHolder.ItemViewHolderSeller;
...
public class SellerHomeActivity extends AppCompatActivity {
    ...
    private String sellerPhoneNumber = "1234567891";
            ...
            public void onNavigationItemReselected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.logout: {
                        ...
                        Intent intentMain = new Intent(SellerHomeActivity.this, home.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(sellerProductsRef.orderByChild("sellerphone").equalTo(sellerPhoneNumber), Products.class)
                        .build();
