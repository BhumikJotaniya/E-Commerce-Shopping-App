...
public class toys extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toys);  // Correct layout file name
    ...
    protected void onStart() {
        ...
        // Set up FirebaseRecyclerOptions to query for products in the "toys" category
        options = new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(ProductRef.orderByChild("category").equalTo("toys"), Products.class)
                .build();
        ...
        adapter = new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(v -> {
                    Intent intent = new Intent(toys.this, ProductDetailsActivity.class);
            ...
            public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(toys.this).inflate(R.layout.product_items_layout, parent, false);
